(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Workday, Inc., LEI
  549300J0DYC0N31V7G13) -- unlike `commitledger.store`'s multi-application
...
(def ^:private demo-full-text
  "Site Terms of Use\nBy accessing this website you agree to these Site Terms. The content of this site is provided by Workday, Inc. for informational purposes about its enterprise HR and finance cloud software and is subject to change without notice. These Terms are governed by the laws of the State of Delaware.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.workday.com/en-us/legal/site-terms.html"
