...
Workday, Inc., per ADR-2607110300 -- a read-only reference archive. As part
of a third 10-repo validation batch extending the
...
- **Company**: Workday, Inc., LEI 549300J0DYC0N31V7G13, website
  `https://www.workday.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://www.workday.com/en-us/legal/site-terms.html`,
